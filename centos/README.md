...
docker run --tmpfs=/run --tmpfs=/tmp \
  ...
  --volume=/run/containers/pcp-java-app-centos:/run/pcp --volume=/sys/fs/cgroup:/sys/fs/cgroup \
  cirepo/service-base-image-java:openjdk-11.0.2-en_US.UTF-8_Etc.UTC-centos


docker exec -it pcp-java-app-centos /bin/bash -l
