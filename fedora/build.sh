...
export IMAGE_TAG=${IMAGE_ARG_JAVA_VENDOR:-openjdk}-${IMAGE_ARG_JAVA_VERSION:-11.0.2}-${IMAGE_ARG_LOCALE:-en_US}.${IMAGE_ARG_ENCODING:-UTF-8}_${IMAGE_ARG_TZ_AREA:-Etc}.${IMAGE_ARG_TZ_ZONE:-UTC}-fedora
